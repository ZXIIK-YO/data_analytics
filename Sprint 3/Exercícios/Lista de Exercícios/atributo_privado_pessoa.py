...
class Pessoa:
    def __init__(self, id):
        self.__nome = None  # Inicializa __nome como None
        self.id = id  # Atributo público id

    # Getter para obter o valor do atributo __nome
    @property
    def nome(self):
        return self.__nome

    # Setter para definir o valor do atributo __nome
    @nome.setter
